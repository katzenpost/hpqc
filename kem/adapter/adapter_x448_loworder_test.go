...
func TestX448DecapsulateLowOrderPointErrorsNotPanic(t *testing.T) {
	s := FromNIKE(x448.Scheme(rand.Reader))
...
func TestX448EncapsulateLowOrderPointErrorsNotPanic(t *testing.T) {
	s := FromNIKE(x448.Scheme(rand.Reader))
